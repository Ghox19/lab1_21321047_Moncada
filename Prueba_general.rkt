...
(define f10 (flow 1 "Flujo Principal Chatbot 1" op1 op2 op2 op2 op2 op1)) ;solo añade una ocurrencia de op2
...
(define op9 (option 3 "3) Ningun otro atractivo" 1 3 "Museo"))
...
(define op14 (option 4 "4) Agregar mas atractivos" 1 2 "Volver" "Atractivos"))
(define op15 (option 5 "5) En realidad quiero otro destino" 1 1 "Cambiar destino"))
(define f20 (flow 1 "Flujo 1 Chatbot1" op3 op4 op5 op6))
(define f21 (flow 2 "Flujo 2 Chatbot1" op7 op8 op9 op10))
(define f22 (flow 3 "Flujo 3 Chatbot1" op11 op12 op13 op14 op15))
...
(define f30 (flow 1 "Flujo 1 Chatbot2" op16 op17 op18))
